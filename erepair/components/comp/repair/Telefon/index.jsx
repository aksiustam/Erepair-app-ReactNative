...
import { TelefonMarkaData } from "../../../../constant/TelefonMarka";
            ...
            >
              <View className="w-28 h-28 flex items-center justify-center">
                {item.img !== null ? (
                  ...
                  <FontAwesome name="mobile-phone" size={80} color="black" />
                )}
              </View>
