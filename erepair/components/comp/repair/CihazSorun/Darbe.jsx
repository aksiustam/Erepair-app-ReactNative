...
const DarbePage = ({ pctamir, setPageContent, sorundata }) => {
  ...
  const onSubmit = async (data) => {
    if (checkmedia) {
      ...
      await Alert.alert(
        "Başarılı!",
        "Cihazınızın Darbe Alma Sorunu Başarıyla Kaydedildi."
      );
      if (bucket1.sorun.some((item) => item.check === false)) {
        await Alert.alert(
          "Devam Ediniz!",
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                3- Bilgisayarınızın Ek Durumu ve Aldığı Hasarı belirtiniz.
              </Text>

              <Text className="text-xl font-gregular block">
                4- Bilgisayarınızda Hasar sonucu değişmesini istediğiniz
                kısımları belirtiniz.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Cihazınızın ek durumu ve Hasarını belirtiniz.
              </Text>
              <Text className="text-xl font-gregular block ">
                5- Cihazınızın Yapılmasını istediğiniz kısımları belirtiniz.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                3- Cihazınızın ek durumu ve hasarını belirtiniz.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                3- Oyun Konsolunun Aldığı Hasarı belirtmeniz yeterlidir.
              </Text>
              <View className="mt-3 w-fit flex items-center justify-center">
                <Pressable
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Cihazınızın Aldığı darbeyi belirtmeniz yeterlidir.
              </Text>
              <View className="mt-3 w-fit flex items-center justify-center">
                <Pressable
