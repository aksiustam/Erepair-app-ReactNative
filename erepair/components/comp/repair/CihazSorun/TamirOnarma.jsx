...
const TamirOnarmaPage = ({ pctamir, setPageContent, sorundata }) => {
  ...
  const onSubmit = async (data) => {
    if (checkmedia) {
      ...
      await Alert.alert(
        "Başarılı!",
        "Cihazınızı Tamir Etme Sorunu Başarıyla Kaydedildi."
      );
      if (bucket1.sorun.some((item) => item.check === false)) {
        await Alert.alert(
          "Devam Ediniz!",
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block">
                4- Bilgisayarınızda Tamir Olacak Yeri Ayrıntılarıyla belirtiniz.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                5- Telefon/Tablet cihazınızın Tamir olacak kısmını
                ayrıntılarıyla belirtin.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Cihazınızıda tamir olacak kısmı ayrıntılarıyla belirtiniz.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Oyun Konsolunda tamir olacak kısmı ayrıntılarıyla belirtiniz.
              </Text>
              <View className="mt-3 w-fit flex items-center justify-center">
                <Pressable
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Cihazınızda tamir olacak kısmı ayrıntılarıyla belirtiniz.
              </Text>
              <View className="mt-3 w-fit flex items-center justify-center">
                <Pressable
      ...
      <View className="h-full mx-2 ">
        <View className="px-6 py-1 rounded-full bg-white my-3">
          <Text className="text-2xl font-gmedium text-center">
            Tamir Olacak Cihazın Bilgilerini Girelim!
          </Text>
        </View>
...
export default TamirOnarmaPage;
