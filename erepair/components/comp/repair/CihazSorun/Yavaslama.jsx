...
const YavaslamaPage = ({ pctamir, setPageContent, sorundata }) => {
  ...
  const onSubmit = async (data) => {
    if (checkmedia) {
      ...
      await Alert.alert(
        "Başarılı!",
        "Cihazınızın Yavaşlama Sorunu Başarıyla Kaydedildi."
      );
      if (bucket1.sorun.some((item) => item.check === false)) {
        await Alert.alert(
          "Devam Ediniz!",
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              <Text className="text-xl font-gregular block ">
                1- Bilgisayarınızın İşletim Sistemini ve Sürümünü Yazınız. (
                Windows 10 / Apple Ventura)
              </Text>
              <Text className="text-xl font-gregular block ">
              ...
              <Text className="text-xl font-gregular block">
                4- Windows Kurulu Bilgisayarınızın Bilgilerini Öğrenmek için ;
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Telefon/Tablet inize en son ne zaman reset / format atıldı
                yazınız.
              </Text>
      ...
      <View className="h-full mx-2 ">
        <View className="px-6 py-1 rounded-full bg-white my-3">
          <Text className="text-2xl font-gmedium text-center">
            Yavaşlayan Cihazın Bilgilerini Girelim!
          </Text>
        </View>
