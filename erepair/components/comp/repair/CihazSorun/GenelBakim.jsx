...
const GenelBakimPage = ({ pctamir, setPageContent, sorundata }) => {
  ...
  const onSubmit = async (data) => {
    if (checkmedia) {
      ...
      await Alert.alert(
        "Başarılı!",
        "Cihazınızın Genel Bakımı sorunu Başarıyla Kaydedildi."
      );
      if (bucket1.sorun.some((item) => item.check === false)) {
        await Alert.alert(
          "Devam Ediniz!",
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                2- Bilgisayarınızın Ek Durumu ve varsa Hasarını belirtiniz.
              </Text>
              <Text className="text-xl font-gregular block">
                3- Windows Kurulu Bilgisayarınız Açılıyorsa Bilgilerini Öğrenmek
                için ;
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                3-1- Bilgisayarım {">"} Sağ Tıkla {">"} Özellikler {">"} den
                İşlemci ve Ram Miktarını Öğreniniz.
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                3-2- Başlat Menüsü {">"} Sağ Tıkla {">"} Aygıt Yöneticisi {">"}
                Görüntü Bağdaştırıcılarını Açarak
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                3-3- Çıkan bilgilerden bir veya ikisini birden Ekran Kartı
                Kısmına Giriniz.
              </Text>
              <Text className="text-xl font-gregular block pt-2">
                4- Apple Kurulu Bilgisayarınız Açılıyorsa Bilgilerini Öğrenmek
                için ;
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                4-1- Yukarıdaki Menüden Sol Üstteki Apple Logosuna Tıklayın.
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                4-2- Bu Mac Hakkında seçeneğine tıklayın
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                4-3 Çıkan bilgilerden Cihazın model adı ve yılını girmeniz
                yeterlidir.
              </Text>
