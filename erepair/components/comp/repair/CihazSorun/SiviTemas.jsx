...
const SiviTemasPage = ({ pctamir, setPageContent, sorundata }) => {
  ...
  const onSubmit = async (data) => {
    if (checkmedia) {
      ...
      await Alert.alert(
        "Başarılı!",
        "Cihazınızın Sıvı Teması Sorunu Başarıyla Kaydedildi."
      );
      if (bucket1.sorun.some((item) => item.check === false)) {
        await Alert.alert(
          "Devam Ediniz!",
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block">
                4- Sıvı Teması bilgisayarın neresinde olduğu, hangi sıvı ve ilk
                müdahale sonrasını yazınız.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Cihazınızın ek durumunu ve hangi sıvının temas ettiğini,
                ayrıca sıvı temasından dolayı oluşan hasarı yazınız.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Sıvı Temasında Oluşan Hasarı ve temas ettiği sıvıyı yazınız.
              </Text>
              <View className="mt-3 w-fit flex items-center justify-center">
                <Pressable
      ...
      <View className="h-full mx-2 ">
        <View className="px-6 py-1 rounded-full bg-white my-3">
          <Text className="text-2xl font-gmedium text-center">
            Sıvı Teması Olmuş Cihazın Durumunu Girelim!
          </Text>
        </View>
