...
const YukseltHizlandirPage = ({ pctamir, setPageContent, sorundata }) => {
  ...
  const onSubmit = async (data) => {
    if (checkmedia) {
      ...
      await Alert.alert(
        "Başarılı!",
        "Cihazınızıda Donanım Yükseltme Sorunu Başarıyla Kaydedildi."
      );
      if (bucket1.sorun.some((item) => item.check === false)) {
        await Alert.alert(
          "Devam Ediniz!",
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              <Text className="text-xl font-gregular block ">
                1- Bilgisayarınızın Markası ve Model No'su gözükecek şekilde
                Fotoğraf çekmeniz veya Yazmanız yeterli
              </Text>
              <Text className="text-xl font-gregular block ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Bilgisayarınızın Donanım Yükseltmesi yapılacak kısmını
                belirtiniz ve mümkünse Fotograf/Video Çekiniz.
              </Text>
      ...
      <View className="h-full mx-2 ">
        <View className="px-6 py-1 rounded-full bg-white my-3">
          <Text className="text-2xl font-gmedium text-center">
            Donanım Yükseltmesi Yapılacak Cihazın Bilgilerini Girelim!
          </Text>
        </View>
...
export default YukseltHizlandirPage;
