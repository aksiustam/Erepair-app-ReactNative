...
const KapanmaPage = ({ pctamir, setPageContent, sorundata }) => {
  ...
  const onSubmit = async (data) => {
    if (checkmedia) {
      ...
      bucket1.formData = data;
      await setPCTamir(bucket1);

      await Alert.alert(
        "Başarılı!",
        "Cihazınızın Kapanma Sorunu Başarıyla Kaydedildi."
      );
      if (bucket1.sorun.some((item) => item.check === false)) {
        await Alert.alert(
          "Devam Ediniz!",
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Bilgisayarınız hangi durumlarda kapanma sorunu yapıyor
                belirtiniz.
              </Text>
              <Text className="text-xl font-gregular block">
                5- Windows Kurulu Bilgisayarınız Açılıyorsa Bilgilerini Öğrenmek
                için ;
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                5-1- Bilgisayarım {">"} Sağ Tıkla {">"} Özellikler {">"} den
                İşlemci ve Ram Miktarını Öğreniniz.
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                5-2- Başlat Menüsü {">"} Sağ Tıkla {">"} Aygıt Yöneticisi {">"}
                Görüntü Bağdaştırıcılarını Açarak
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                5-3- Çıkan bilgilerden bir veya ikisini birden Ekran Kartı
                Kısmına Giriniz.
              </Text>
              <Text className="text-xl font-gregular block pt-2">
                6- Apple Kurulu Bilgisayarınız Açılıyorsa Bilgilerini Öğrenmek
                için ;
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                6-1- Yukarıdaki Menüden Sol Üstteki Apple Logosuna Tıklayın.
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                6-2- Bu Mac Hakkında seçeneğine tıklayın
              </Text>
              <Text className="text-xl font-gregular block pl-3">
                6-3 Çıkan bilgilerden Cihazın model adı ve yılını girmeniz
                yeterlidir.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                5- Cihazınız hangi durumlarda kapanma sorunu yapıyor belirtiniz.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Cihazınız hangi durumlarda kapanma sorunu yapıyor belirtiniz.
              </Text>
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView} className="px-3 py-3 ">
              ...
              <Text className="text-xl font-gregular block ">
                4- Oyun Konsolunun hangi durumlarda kapanma sorunu yapıyor
                belirtiniz.
              </Text>
              <View className="mt-3 w-fit flex items-center justify-center">
                <Pressable
      ...
      <View className="h-full mx-2 ">
        <View className="px-6 py-1 rounded-full bg-white my-3">
          <Text className="text-2xl font-gmedium text-center">
            Kapanma Sorunu için Cihazın Bilgilerini Girelim!
          </Text>
        </View>
